...
{        
    document.getElementById('descripcionBg1').style.animation = "none";
    document.getElementById('descripcionBg1').style.width = "0%";
    document.getElementById('descripcionTexto1').style.animation = "none";
...
{        
    document.getElementById('descripcionBg2').style.animation = "none";
    document.getElementById('descripcionBg2').style.width = "0%";
    document.getElementById('descripcionTexto2').style.animation = "none";
...
{        
    document.getElementById('descripcionBg3').style.animation = "none";
    document.getElementById('descripcionBg3').style.width = "0%";
    document.getElementById('descripcionTexto3').style.animation = "none";
...
{        
    document.getElementById('descripcionBg4').style.animation = "none";
    document.getElementById('descripcionBg4').style.width = "0%";
    document.getElementById('descripcionTexto4').style.animation = "none";
...
{        
    document.getElementById('descripcionBg5').style.animation = "none";
    document.getElementById('descripcionBg5').style.width = "0%";
    document.getElementById('descripcionTexto5').style.animation = "none";
...
{        
    document.getElementById('descripcionBg6').style.animation = "none";
    document.getElementById('descripcionBg6').style.width = "0%";
    document.getElementById('descripcionTexto6').style.animation = "none";
...
{        
    document.getElementById('descripcionBg7').style.animation = "none";
    document.getElementById('descripcionBg7').style.width = "0%";
    document.getElementById('descripcionTexto7').style.animation = "none";
...
{        
    document.getElementById('descripcionBg8').style.animation = "none";
    document.getElementById('descripcionBg8').style.width = "0%";
    document.getElementById('descripcionTexto8').style.animation = "none";
...
{        
    document.getElementById('descripcionBg9').style.animation = "none";
    document.getElementById('descripcionBg9').style.width = "0%";
    document.getElementById('descripcionTexto9').style.animation = "none";
...
{        
    document.getElementById('descripcionBg10').style.animation = "none";
    document.getElementById('descripcionBg10').style.width = "0%";
    document.getElementById('descripcionTexto10').style.animation = "none";
