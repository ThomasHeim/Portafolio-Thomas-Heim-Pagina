...
{        
    document.getElementById('trabajos').style.backgroundImage = "url('/img/ilustracion1.png')";
...
document.getElementById('ux__third').onmouseout = function()        
{        
    document.getElementById('trabajos').style.backgroundImage = "none";
};
...
document.getElementById('ux__fourth').onmouseout = function()        
{        
    document.getElementById('trabajos').style.backgroundImage = "none";
};
